...
static llvm::cl::opt<std::string> DirOption("d", llvm::cl::desc("EMI output directory"), llvm::cl::cat(DiffOptionCategory));
...
int main(int argc, const char *argv[])
{
    ...
    Tool.run(newDiffFrontendActionFactory(sources[0], sources[1]).get());
}